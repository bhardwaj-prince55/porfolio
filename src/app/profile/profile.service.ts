...
export class ProfileService {
  ...
  projects:any = [
    {
      id: 1,
      title: 'INR crypto currency exchange with Spot Trading',
      desc: '',
      livedemo: 'https://koinpro.io/',
      githurl: '',
      mediumlink: 'https://itnext.io/read-data-from-google-spreadsheet-in-angular-209ee74b6cb4',
      imgUrl: 'assets/images/z1.png',
      tech: 'Angular 14 , crypto currency exchange'
    },

    {
      id: 2,
      title: 'Home | Bitcoin Exchange | Cryptocurrency Exchange | CoinExcha',
      desc: '',
      livedemo: 'https://coinexcha.com/',
      githurl: '',
      mediumlink: '',
    ...
    {
      id: 3,
      title: 'Bill Payments Web',
      desc: '',
      livedemo: 'http://rtmb2c.in',
      githurl: '',
      mediumlink: '',
      imgUrl: 'assets/images/z27.png',
      tech: 'Angular 7.2.3, Dot Net'
    },
  ...
  Have good understanding of Bootstrap, MongoDB, Firebase, and Little knowledge about mobile application development Angular with Ionic framework`
...
Completed my Secondary school with 84%.`
  ...
  exprienceData: any = [
    {
      id: 4,
      company: 'RoundPay Technologies Pvt. Ltd',
      location: 'LuckNow',
      timeline: 'sep 2022 to Present',
      role: 'Software Developer',
      work: 'Working as a Front-end developer .Responsible for handling the UI in Angular and Managing the api calls in Node.js.'

    },
    {
      id: 3,
      company: 'Eitbiz Extrovert Tech. Pvt Ltd',
      location: 'Delhi',
      timeline: 'Feb 2020 to June 2021',
      role: 'Software Developer',
  ...
  //   },
    ...
    {
      id: 1,
      company: 'Mobiolloite Technologies',
      location: 'Delhi ',
      timeline: 'June 2019 - Jan 2020',
      role: 'Assistant System Engineer Trainee',
      work: `Technologies : Work as Trainee  Angular , JavaScript , Ionic 4 .`
    },
  ]
